...
|Characteristics of information|<ol><li>**Commodity:** Can be bought and sold, exchanged and patented, but it is not depleted when used.<li>**Expand:** Potential demand is unlimited.<li>**Resources:** Economy is based on information.|
...
| Item | Definition |
|-|-|
|Define Information Institutions|Institution or center to organize and provide information so that it will be retrievable for various purposes and also provide resources, services to the users.|
...
|1. Libraries|Rely on efforts of collection development to fulfill their missions.|
|Library developments|<ol><li>**Selection:** learn about existing and new works from reviews, publishers' announcement, requests from patrons.<li>**Gifts and Exchanges:** Gifts donated from interested party. Exchanges mutual beneficial trade agreement with one or more other libraries.<li>**Approval plan:** Prearranges relationships with book vendors that supply titles based on a pre-designed profile. <li>**Patron driven accusations:** Library obtains certain resouces only after the need for them has been definitively established.|
|Explain organization process in library |<ol><li> **Arrange and Classify:** Arranged by alphabetically, Dewey Decimal Classification, Library of Congress Classification. <li> **Cataloguing & Classification Process:** Creating a description of the physical item, choosing certain names and title as access points, authority work, subject analysis, creating a call number.<li>**MARC (Machine Readable Format):** This information is almost always entered in the MARC record where it becomes electronically retrievable in the form of union catalogs (i.e. OCLC, TRLN, WNCLN, UNC Coastal Library Consortium, etc).|
|2. Digital Library|A collection of Information Resources in digital form that are selected, brought together, organized, preserved, and to which access is provided over digital networks for a particular community of users.|
|Explain organization process in digital library|<ol><li>Selection of documents and scanning<li>Storage and management standards<li>Search and access<li>Distribution<li>Rights management|
|3. Archive|Consists of unique items, preserving records of enduring value. Archive records are organized and described in groups.|
|Principles of arranging archive|<li>**Provenance:** Originator that created, gathered or maintained the collection before it was sent to archive. The ownership history of a particular artifacts/collection of archival information.<li>**Original Order:** The sequence in which the originator of an archival collection kept or created the collection.|
|3 distinct activities in processing archival collections|<ol><li>Gather and analysing information about the collection (a.k.a. *Accession records*).<li>Organizing and arranging the collection.<li>Create *finding aids* to provide access to the collection.|
|How archive is being kept?|Generally housed in boxes kept in closed stacks, accessible only to staff. |
|Accession records|Summarizes information about source of collection, briefly describes the physical data and contents for a collection.|
|Finding aids|Tool to retrieve archival collections, gives detail notes of historical and organizational context of the collection, providing outlining of what's in the box.|
|Standards used in Archive|<li>Machine Readable Cataloging for Archival and Manuscript Control (MARC-AMC)<li>Encoded Archival Description (EAD) to encode finding aids to be displayed in the Web.|
|4. Museum and Art Gallery; Types of collection|Visual material in 2D or 3D form.|
|*Remark*|Collections are less standardized as result are less likely to be retrieved electronically.|
|Principles of organization in Museum & Art Gallery|<ol><li>**Provenance:** Essential in determining name and elements describing the particular object.<li>**Accession record:** Groups of singular objects are described as a single lot that is given asingle accession number.<li>**Register:** It serves as a catalog, where it establishes the organizational control over works and artifacts.|
|Challenges|<ol><li>Objects are often imperfectly known at the time of accessioning and registering, there is a chance of accumulation of conflicting over time.<li>Lack of text make interpretation of item or collection more subjective.|
|*Remark*|<li>Museum can also have archives, record management programmed and libraries.<li>Collection are stored behind the scenes. Items are numbered so they can be retrieved as needed.|
|Standards|<li>Metadata schemas: Categories for the descriptions of works of art (CDWA)<li>Controlled vocab: Thesaurus for graphic materials (TGM), Getty Vocabularies, Iconclass<li>Content standards: Cataloging cultural objects (CCO)|
|5. The Internet|INFOMINE, Virtual Libraries|
...
|Introduction OCLC|<li>Founded in Ohio (1967) – known as Ohio College Library Center (OCLC) by the Presidents of Ohio State colleges and universities. <li>Introduced as online shared cataloguing system for libraries in 1971.<li>OCLC was first demonstrated to librarians during IFLA & UNESCO seminar in Liverpool 1971.|
